...
//            @Override
//            public void run() {
//                final byte[] pdu = buildPdu(activity, recipients, subject, text);
...
//                        activity, 0, new Intent(ACTION_MMS_SENT), 0);
...
//
//                if (contentUri != null) {
//                    SmsManager.getDefault().sendMultimediaMessage(activity,
...
//                        .build();
//                final PendingIntent pendingIntent = PendingIntent.getBroadcast(
//                        activity, 0, new Intent(ACTION_MMS_RECEIVED), 0);
//                SmsManager.getDefault().downloadMultimediaMessage(activity,
...
//        mSendFile.delete();
//        int status = 1;//R.string.mms_status_failed;
...
//                        status = 2;//R.string.mms_status_sent;
//                    } else {
...
//        int status = 2; //R.string.mms_status_failed;
//        if (code == Activity.RESULT_OK) {
//            try {
